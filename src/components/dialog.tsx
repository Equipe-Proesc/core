...
function Dialog({ children, open, defaultOpen, onOpenChange }:BaseDialogProps) {
    const isControlled = open !== undefined;
    const [outerOpen, setOuterOpen] = React.useState(defaultOpen ?? false);
    const openState = isControlled ? open! : outerOpen;

    const handleOpenChange = (o: boolean) => {
        if (!isControlled) setOuterOpen(o);
        onOpenChange?.(o);
    };
